...
var Auth = /** @class */ (function () {
    ...
    Auth.prototype.authenticateWithCertificate = function (cpf, password, certPath) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Auth.prototype.exchangeCertificates = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var payload, data, cert, certCrypto;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                cert: (0, cert_1.generateSelfSignedCertificate)(this._keyPair, cert),
                                certCrypto: (0, cert_1.generateSelfSignedCertificate)(this._keyPairCrypto, certCrypto),
                            }];
                }
            });
        });
