...
var NubankApi = /** @class */ (function () {
    function NubankApi(params) {
        if (params === void 0) { params = {}; }
        this.accessToken = "";
        this.privateUrls = {};
        this.publicUrls = {};
        this.options = {
            uuidAdapter: uuid_1.v4,
        };
    ...
    NubankApi.prototype.login = function (cpf, password, validateCallback) {
        return __awaiter(this, void 0, void 0, function () {
            var url, options, data, uuid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, validateCallback(uuid)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, this.validateLogin(uuid)];
                }
            });
        });
    };
    ...
    NubankApi.prototype.validateLogin = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            var payload, _a, access_token, _links;
    ...
    NubankApi.prototype.getBillDetails = function (bill) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        url = ((_b = (_a = bill === null || bill === void 0 ? void 0 : bill._links) === null || _a === void 0 ? void 0 : _a.self) === null || _b === void 0 ? void 0 : _b.href) || "";
                        if (!url) {
